...
<body>
	<div class="wrapper ">
		<div class="sidebar" data-color="purple" data-background-color="white">
			<div class="logo">
				<a  class="nav-link" href="{{route('dashboard')}}" class="simple-text logo-mini">
					LOJA ONLINE
				</a>
			</div>
							...
							<div class="col-md">
								<div class="card">
									<div class="card-header card-header-primary">
										<h4 class="card-title">Edite seu fornecedor</h4>
										<p class="card-category">Preencha corretamente</p>
									</div>
									<div class="card-body">
										<form action="{{route('update-fornecedor', ['id' => $fornecedores->id])}}" method="POST">
											@csrf
											<div class="row">
												<div class="col-md-4">
