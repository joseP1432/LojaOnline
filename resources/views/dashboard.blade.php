          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title ">Sua loja online</h4>
                <p class="card-category"> O jeito mais fácil de administra-la</p>
              </div>
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <h2 class="text-primary text-center mt-3">Administre sua loja online, para que assim possa trabalhar com maior facilidade e organização!</h2>
                  </div>
                  <div class="col-md-6">
                    <img src="storage/icone.jpg" alt="" width="70%">
                  </div>
                </div>
              </div>
            </div>
